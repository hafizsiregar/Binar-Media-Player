package com.example.binarmediaplayer.data

import com.example.binarmediaplayer.R
import com.example.binarmediaplayer.model.VideoYoutubeModel

object VideoYoutubeData {
    private val thumbnailVideo = intArrayOf(
        R.drawable.thumbnail_video_youtube_1,
        R.drawable.thumbnail_video_youtube_2,
        R.drawable.thumbnail_video_youtube_3,
        R.drawable.thumbnail_video_youtube_4,
        R.drawable.thumbnail_video_youtube_5
    )
    ...
    val listData: ArrayList<VideoYoutubeModel>
        get() {
            val list = arrayListOf<VideoYoutubeModel>()
            for (position in channelVideo.indices) {
                val video = VideoYoutubeModel()
